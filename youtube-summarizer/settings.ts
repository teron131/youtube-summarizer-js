...
export function getSettings(): AppSettings {
    ...
    cachedSettings = {
        ...
        defaultTargetLanguage: asTargetLanguage(
            readEnv("DEFAULT_TARGET_LANGUAGE"),
        ),
        ...
        supadataTranscriptUrl:
            readEnv("SUPADATA_TRANSCRIPT_URL") ??
            DEFAULTS.supadataTranscriptUrl,
        openrouterSummaryModel:
            readEnv("OPENROUTER_SUMMARY_MODEL") ??
            DEFAULTS.openrouterSummaryModel,
        ...
        mcpGoogleRequiredScopes:
            readEnv("MCP_GOOGLE_REQUIRED_SCOPES") ??
